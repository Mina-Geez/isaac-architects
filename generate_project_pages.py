...
.nav-call{display:none;align-items:center;justify-content:center;width:44px;height:44px;
color:var(--paper);text-decoration:none;transition:color .3s}
.nav-call:hover,.nav-call:active{color:var(--stone)}
...
@media(max-width:768px){
  ...
  .nav-call{display:inline-flex;margin-left:auto;margin-right:.25rem}
...
<nav class="nav">
  ...
  <a class="nav-call" href="tel:+201274348575" aria-label="Call the studio">
