...
ROOT = r"C:\Users\test-\OneDrive\Desktop\Isaac Architects"
...
.project-hero{position:relative;height:90vh;min-height:600px;background:var(--deep);overflow:hidden}
...
@media(max-width:768px){
  ...
  .project-hero{height:70vh;min-height:500px}
